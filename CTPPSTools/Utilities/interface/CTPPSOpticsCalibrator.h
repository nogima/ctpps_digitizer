#ifndef CTPPS_OPTICS_CALIBRATION
#define CTPPS_OPTICS_CALIBRATION
...
public:
        ...
        CTPPSOpticsCalibrator(const std::string,const std::string,int =250);
        ~CTPPSOpticsCalibrator(){};
