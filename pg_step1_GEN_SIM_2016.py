...
from Geometry.VeryForwardGeometry.geometryCTPPSFromDD_2016_cfi import XMLIdealGeometryESSource_CTPPS
...
from SimCTPPS.CTPPSSimTrackProducer.SimTrackProducerForFullSim_cff import customise
process = customise(process)

process.LHCTransport.BeamProtTransportSetup.Model_IP_150_L_Zmax = cms.double(203.737)  
process.LHCTransport.BeamProtTransportSetup.Model_IP_150_R_Zmax = cms.double(-203.737) 
