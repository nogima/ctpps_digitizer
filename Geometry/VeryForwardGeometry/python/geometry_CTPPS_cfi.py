...
totemGeomXMLFiles = cms.vstring(
	'Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/VeryForwardData/data/CTPPS_220_Right_Station.xml',
        'Geometry/VeryForwardData/data/CTPPS_220_Left_Station.xml',
...
# position of RPs
XMLIdealGeometryESSource_CTPPS.geomXMLFiles.append("Geometry/VeryForwardData/data/RP_Dist_Beam_Cent.xml")
