...
class CTPPSTotemDataFormatter {
  ...
  private:
    ...
    const std::map<TotemFramePosition, TotemVFATInfo> &mapping_;
  ...
  public:
    ...
    void formatRawData(unsigned int lvl1_ID, RawData & fedRawData, const Digis & digis, std::map<std::map<const uint32_t, unsigned int>, std::map<short unsigned int, short unsigned int>> iDdet2fed );
    //void formatRawData(unsigned int lvl1_ID, RawData & fedRawData, const Digis & digis, std::map<std::map<const uint32_t, unsigned int>, std::map<short unsigned int, short unsigned int>> iDdet2fed,  std::map<TotemFramePosition, CTPPSTotemDigiToRaw::Record> &record );
