...
#    ChargeMapFile2E      = cms.string("SimCTPPS/CTPPSPixelDigiProducer/data/PixelChargeMap.txt"),
#    ChargeMapFile2E_2X   = cms.string("SimCTPPS/CTPPSPixelDigiProducer/data/PixelChargeMap_2X.txt"),
#    ChargeMapFile2E_2Y   = cms.string("SimCTPPS/CTPPSPixelDigiProducer/data/PixelChargeMap_2Y.txt"),
#    ChargeMapFile2E_2X2Y = cms.string("SimCTPPS/CTPPSPixelDigiProducer/data/PixelChargeMap_2X2Y.txt"),
