...
// RPixChargeShare
  desc.add<std::string>("ChargeMapFile2E","SimCTPPS/CTPPSPixelDigiProducer/data/PixelChargeMap.txt");
...
// RPixDummyROCSimulator
  ...
  desc.add<bool>("RPixDeadPixelSimulationOn",false);
...
// CTPPSPixelSimTopology
 ...
 descriptions.add("ctppspixeldigitizer", desc);
}
