// -*- C++ -*-
//
// Package:    SimCTPPS/CTPPSSimTrackProducer
// Class:      CTPPSSimTrackProducer
// 
/**\class CTPPSSimTrackProducer CTPPSSimTrackProducer.cc SimCTPPS/CTPPSSimTrackProducer/plugins/CTPPSSimTrackProducer.cc
...
#include "SimTransport/CTPPSProtonTransport/interface/TotemTransport.h"
#include "SimTransport/CTPPSProtonTransport/interface/HectorTransport.h"
#include "SimTransport/CTPPSProtonTransport/interface/ProtonTransport.h"
#include "TRandom3.h"
...
class CTPPSSimTrackProducer : public edm::stream::EDProducer<> {
   public:
      explicit CTPPSSimTrackProducer(const edm::ParameterSet&);
      ~CTPPSSimTrackProducer();
...
//
CTPPSSimTrackProducer::CTPPSSimTrackProducer(const edm::ParameterSet& iConfig)
{
...
CTPPSSimTrackProducer::~CTPPSSimTrackProducer()
{
...
void
CTPPSSimTrackProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
CTPPSSimTrackProducer::beginStream(edm::StreamID)
{
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void
CTPPSSimTrackProducer::endStream() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
CTPPSSimTrackProducer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
CTPPSSimTrackProducer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
CTPPSSimTrackProducer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
CTPPSSimTrackProducer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
CTPPSSimTrackProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(CTPPSSimTrackProducer);
