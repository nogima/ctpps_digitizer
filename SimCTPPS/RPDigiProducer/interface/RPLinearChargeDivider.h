#ifndef SimCTPPS_RPDigiProducer_RP_LINEAR_CHARGE_DIVIDER_H
#define SimCTPPS_RPDigiProducer_RP_LINEAR_CHARGE_DIVIDER_H
...
#endif  //SimCTPPS_RPDigiProducer_RP_LINEAR_CHARGE_DIVIDER_H
