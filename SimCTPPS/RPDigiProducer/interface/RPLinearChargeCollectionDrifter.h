#ifndef SimCTPPS_RPDigiProducer_RP_LINEAR_CHARGE_COLLECTION_DRIFTER_H
#define SimCTPPS_RPDigiProducer_RP_LINEAR_CHARGE_COLLECTION_DRIFTER_H
...
#endif  //SimCTPPS_RPDigiProducer_RP_LINEAR_CHARGE_COLLECTION_DRIFTER_H
