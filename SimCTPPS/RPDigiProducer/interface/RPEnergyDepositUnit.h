#ifndef SimCTPPS_RPDigiProducer_RP_ENERGY_DEPOSIT_UNIT_H
#define SimCTPPS_RPDigiProducer_RP_ENERGY_DEPOSIT_UNIT_H
...
#endif  //SimCTPPS_RPDigiProducer_RP_ENERGY_DEPOSIT_UNIT_H
