#ifndef SimCTPPS_RPDigiProducer_RP_PILE_UP_SIGNALS_H
#define SimCTPPS_RPDigiProducer_RP_PILE_UP_SIGNALS_H
...
#endif  //SimCTPPS_RPDigiProducer_RP_PILE_UP_SIGNALS_H
