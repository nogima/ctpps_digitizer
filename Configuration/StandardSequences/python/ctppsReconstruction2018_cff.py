...
from RecoCTPPS.Configuration.recoCTPPS_DD_2018_cff import *
#
...
###########################################
_fastSim_localreco = localreco.copyAndExclude([castorreco,totemRPLocalReconstruction,ctppsPixelLocalReconstruction,trackerlocalreco])
