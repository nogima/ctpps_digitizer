...
*/
        fCTPPSRegionStart_56=model_ip_150_r_zmax;
        fCTPPSRegionStart_45=model_ip_150_l_zmax;
...
{
     //CTPPSTools::LorentzBoost(*(const_cast<HepMC::GenParticle*>(in_trk)),"LAB");
...
//
     double in_position[3] = {(in_pos->position().x()-fVtxMeanX*cm) / meter+fBeamXatIP*mm/meter,
                              (in_pos->position().y()-fVtxMeanY*cm) / meter+fBeamYatIP*mm/meter, Zin_};
