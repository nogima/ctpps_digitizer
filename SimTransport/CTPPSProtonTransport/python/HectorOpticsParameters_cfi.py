...
Totem_PreTS2_2016 = cms.PSet(
        ...
        Beam1 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB1_Beta0.40_6.5TeV_CR191.541_PreTS2_TOTEM.tfs'),
        Beam2 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB2_Beta0.40_6.5TeV_CR179.394_PreTS2_TOTEM.tfs'),
...
Validated_PreTS2_2016 = cms.PSet(
        ...
        Beam1 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB1_Beta0.40_6.5TeV_CR191.541_PreTS2.tfs'),
        Beam2 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB2_Beta0.40_6.5TeV_CR179.394_PreTS2.tfs'),
        CrossingAngleBeam1  = cms.double(191.541), #in mrad
        CrossingAngleBeam2  = cms.double(179.394), #in mrad
        sigmaEnergy = cms.double(1.11e-4),     ## beam energy dispersion (GeV); if =0.0 the default(=0.79) is used
        sigmaSTX = cms.double(135.071),     ## x angle dispersion at IP (urad); if =0.0 the default(=30.23) is used
...
Nominal_2017_beta40cm = cms.PSet(
        #TotemBeamLine = cms.bool(False),
        Beam1 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB1_Beta0.40_6.5TeV_CR150_Nominal_2017.tfs'),
        Beam2 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB2_Beta0.40_6.5TeV_CR150_Nominal_2017.tfs'),
...
Nominal_2017_beta30cm = cms.PSet(
        #TotemBeamLine = cms.bool(False),
        Beam1 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB1_Beta0.30_6.5TeV_CR175_Nominal_2017.tfs'),
        Beam2 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB2_Beta0.30_6.5TeV_CR175_Nominal_2017.tfs'),
...
Nominal_2016 = cms.PSet(
        #TotemBeamLine = cms.bool(False),
        Beam1 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB1_Beta0.40_6.5TeV_CR185_Nominal_2016.tfs'),
        Beam2 = cms.string('SimTransport/CTPPSProtonTransport/data/LHCB2_Beta0.40_6.5TeV_CR185_Nominal_2016.tfs'),
