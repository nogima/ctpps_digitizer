...
BeamConditionsGlobal = cms.PSet(
    ...
    #Model_IP_150_R_Zmax = cms.double(-203.737),#210Near
    #Model_IP_150_L_Zmax = cms.double(203.737),#
    Model_IP_150_R_Zmax = cms.double(-212.46),#210Far
    Model_IP_150_L_Zmax = cms.double( 212.46),#
    #Model_IP_150_R_Zmax = cms.double(-219.46),#220Far
    #Model_IP_150_L_Zmax = cms.double( 219.46),
