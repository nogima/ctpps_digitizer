...
# Beam parametes for Nominal TDR
Nominal_TDR = cms.PSet(
        #TotemBeamLine = cms.bool(False),
        ...
        sigmaEnergy = cms.double(1.11e-4),     ## beam energy dispersion (GeV); if =0.0 the default(=0.79) is used
        sigmaSTX = cms.double(30.23),     ## x angle dispersion at IP (urad); if =0.0 the default(=30.23) is used
        sigmaSTY = cms.double(30.23),      ## y angle dispersion at IP (urad); if =0.0 the default(=30.23) is used
        sigmaSX  = cms.double(16.63),
        sigmaSY  = cms.double(16.63),
        BeamEnergy = cms.double(6500.0),
        BeamXatIP      = cms.double(0.10482),
        BeamYatIP      = cms.double(0.16867)       
)
